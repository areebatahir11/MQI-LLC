...
//         <svg
//           className="w-7 h-7 text-zinc-400 group-hover:text-zinc-700 transition-colors"
//           fill="none"
//           stroke="currentColor"
//           viewBox="0 0 24 24"
//         >
...
//       <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-orange-100/80 to-transparent z-10 pointer-events-none" />
//       <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-orange-100/80 to-transparent z-10 pointer-events-none" />
...
const PlaceholderAvatar = ({ name }) => {
  ...
  return (
    // FIX 1: bg-white — orange tint hata diya
    <div className="w-full h-full flex flex-col items-center justify-center bg-white relative overflow-hidden">
      {/* Decorative rings */}
      <div className="absolute w-40 h-40 rounded-full border-2 border-zinc-100 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute w-56 h-56 rounded-full border border-zinc-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
      {/* Avatar circle */}
      <div className="relative z-10 w-20 h-20 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-200">
        <span className="text-white text-2xl font-black tracking-tight">
          {initials}
      ...
      {/* Silhouette body hint */}
      <div className="relative z-10 mt-3 w-12 h-5 rounded-full bg-zinc-100" />
    </div>
  );
};
...
const EmptyCard = ({ index }) => (
  <div className="group min-w-[260px] rounded-3xl overflow-hidden border-2 border-dashed border-zinc-800 bg-white/40 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:border-zinc-900 hover:shadow-[0_16px_40px_rgba(0,0,0,0.18)] hover:-translate-y-1 transition-all duration-300">
    {/* FIX 2: bg-white — orange tint hata diya */}
    <div className="w-full h-64 flex flex-col items-center justify-center bg-white relative overflow-hidden">
      {/* Decorative frame corners */}
      <div className="absolute top-3 left-3 w-6 h-6 border-t-2 border-l-2 border-zinc-700/60 rounded-tl-lg" />
      <div className="absolute top-3 right-3 w-6 h-6 border-t-2 border-r-2 border-zinc-700/60 rounded-tr-lg" />
      <div className="absolute bottom-3 left-3 w-6 h-6 border-b-2 border-l-2 border-zinc-700/60 rounded-bl-lg" />
    ...
    {/* FIX 3: bg-zinc — orange tint hata diya */}
    <div className="p-5 text-center">
      <div className="h-3.5 w-2/3 mx-auto rounded-full bg-zinc-100" />
      <div className="h-2.5 w-1/3 mx-auto rounded-full bg-zinc-50 mt-2" />
    </div>
  </div>
);
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-t from-white via-orange-50 to-orange-100 py-28">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        {!loading && (
          <div className="relative w-full overflow-hidden">
            {/* FIX 4: fade edges — orange-900 se orange-50 kiya */}
