...
export default function Services() {
  const services = [
    { icon: "🏚", name: "Building Demolition" },
    { icon: "🌿", name: "Site Clearing" },
    { icon: "⛏", name: "Excavation Work" },
    { icon: "🪨", name: "Concrete Breaking" },
    { icon: "🚛", name: "Debris Removal" },
    { icon: "🦺", name: "Heavy Machinery Operations" },
  ];

  return (
    <section className="relative overflow-hidden bg-white py-28">
      {/* 🔥 Bottom-focused gradient background */}
      ...
      {/* 🔥 Orange soft blobs (bottom focus maintained) */}
